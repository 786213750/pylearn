...
class Claptcha(object):
    ...
    def image(self):
        ...
        image = Image.new('RGB',
                          ...
                          (firstrgb1, secondrgb1, thirdrgb1))
    ...
    def _drawLine(self, image):
        ...
        firstrgb3 = random.randint(0,255)
        secondrgb3 =random.randint(0,255)
        thirdrgb3 = random.randint(0,255)
        
        # Draw
        l_draw.line(((x1, y1), (x2, y2)), fill=(firstrgb3, secondrgb3, thirdrgb3, 255), width=l_width)
